...
/**
 * A classe ProjetoGerenteTM é responsável por atribuir um modelo à tabela de gerentes dos projetos. Para isso
 * aplica-se o conceito de herança da classe AbstractTableModel, que tem uma série de métodos pré definidos para
 * facilitar a atualização da tabela.
 * @author Pedro Henrique
 * @version 3.0 (nov. 2020)
 */
public class ProjetoGerenteTM extends AbstractTableModel {
    //atributos
    private List <String[]> linhas;
    private String[] colunas = new String[]{"Nome","Habilidades"};
    
    /**
     * O construtor sem parâmetros de ProjetoGerenteTM tem como objetivo criar um novo ArrayList do tipo String.
     * 
     */
    public ProjetoGerenteTM(){
    ...
    public ProjetoGerenteTM(List<String[]>lista){

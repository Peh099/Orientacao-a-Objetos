...
/**
 *
 * A classe ProjetoTM é responsável por atribuir um modelo à tabela de projetos. Para isso aplica-se o conceito 
...
public class ProjetoTM extends AbstractTableModel {
    ...
    private String[] colunas = new String[]{"Codigo","Nome","Data Inicio","Data Finalização","Atividades","Stakeholders","Historico","Produtos","Gerente","Status"};
    
    /**
     * O construtor sem parâmetros de ProjetoTM tem como objetivo criar um novo ArrayList do tipo String.
     * 
     */
    public ProjetoTM(){
    ...
    /**
     * O construtor com parâmetro lista de ProjetoTM tem como objetivo criar um novo ArrayList do tipo String recebendo
     * lista 
    ...
    /**
     * O metodo getValueAt retorna um objeto padrão, recuperando o Projeto relacionado a linha especificada e o 
     * atributo relacionado aquele Projeto. Ao atualizar um Projeto, o TableModel irá chamar o metodo getValueAt
    ...
    /**
     * O metodo addProjeto adiciona um novo Projeto à tabela

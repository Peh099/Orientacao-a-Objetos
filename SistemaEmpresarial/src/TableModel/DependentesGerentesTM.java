...
/**
 * A classe DependentesGerenteTM é responsável por atribuir um modelo à tabela de dependentes. Para isso aplica-se
 * o conceito de herança da classe AbstractTableModel, que tem uma série de métodos pré definidos para facilitar a 
 * atualização da tabela.
 * @author Pedro Henrique
 * @version 3.0 (nov. 2020)
 */
public class DependentesGerentesTM extends AbstractTableModel {  
    //atributos
    private List <String[]> linhas;    
    private String[] colunas = new String[]{"Nome do Gerente","Sexo","Data de Nascimento"};
    
    /**
     * O construtor sem parâmetros de DependentesGerenteTM tem como objetivo criar um novo ArrayList do tipo String.
     * 
     */
    public DependentesGerentesTM(){
        linhas=new ArrayList<String[]>();
    }
    /**
     * O construtor com parâmetro lista de DependentesGerenteTM tem como objetivo criar um novo ArrayList do tipo 
     * String recebendo lista 
     * @param lista Lista de String
     */
    
    public DependentesGerentesTM(List<String[]>lista){
